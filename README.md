...
* **Duvan Granado Alzate**
  * *Fortalezas:* Gran capacidad analítica para la optimización de procesos lógicos, estructuración de requerimientos técnicos y liderazgo en la gestión del proyecto.

* **Mario Estrada**
  * *Fortalezas:* Destreza avanzada en la organización de datos, manejo eficiente de herramientas ofimáticas y facilidad para la solución de problemas algorítmicos.

* **Samuel González Contreras**
  * *Fortalezas:* Excelente habilidad para el razonamiento matemático, trabajo colaborativo en equipo y diseño de la estructura del código base en Python.

* **Yeison Solar**
  * *Fortalezas:* Rigurosidad en el control de calidad, enfoque metodológico en la documentación de procesos y soporte en la validación de requerimientos.
...
- `images/` — Logo y diagramas del proyecto
